...
.controller('AccountCtrl', function(
  ...
  */
  ...
  $scope.doLogin = function() {
    if($scope.loginData.userEmail && $scope.loginData.userPassword) {
      Utils.showMessage("Giriş Yapılıyor... ");
  ...
  function proceedLogin(AuthData) {
    ...
    broadcastAuthChange();
    Utils.showMessage("Giriş Yapıldı!", 500);
  ...
  $scope.doSignUp = function() {       console.log('Doing signUp', $scope.signUpData);
    if($scope.signUpData.userEmail && $scope.signUpData.userPassword) {
        Utils.showMessage("Kullanıcı oluşturuluyor... ");
  ...
  $scope.resetPassword = function() {
      if($scope.changePasswordData.userEmail) {
        Utils.showMessage("Parola Güncelleniyor...");
        Auth.resetPassword(
            $scope.changePasswordData.userEmail).then(
            function(success){
                Utils.showMessage("Parola güncellendi. Lütfen bilgilerinizi kontrol ediniz!", 2000);
    ...
    if($scope.changePasswordData.userEmail && $scope.changePasswordData.oldPassword && $scope.changePasswordData.newPassword) {
        ...
        Auth.changePassword(
            ...
            function(AuthData){
                ...
                //
                Utils.showMessage("Parola Güncellendi!");
                //
                $scope.loginData = {
  ...
  $scope.doChangeEmail = function() {       console.log('changeEmail', $scope.changeEmailData);
    if($scope.changeEmailData.oldEmail && $scope.changeEmailData.newEmail && $scope.changeEmailData.userPassword) {
        ...
        Utils.showMessage("e-mail Güncelleniyor...")
        ...
        Auth.changeEmail(
            ...
            function(success){
                ...
                Utils.showMessage("E-mail Güncellendi!", 500)
  ...
  */
  ...
  $scope.changeDisplayName = function() {
    showPopup('İsim değiştir', preparePopupData('meta', 'displayName'));
  ...
  $scope.changeUsername = function() {
    showPopup('Kullanıcı Adı Dğiştir', preparePopupData('meta', 'username'));
  ...
  $scope.changeProfilePicture = function() {
    ...
    $ionicActionSheet.show({
        ...
        titleText: 'Profil Resmini Güncelle',
        cancelText: 'iptal',
        cancel: function() {
            // add cancel code..
        },
